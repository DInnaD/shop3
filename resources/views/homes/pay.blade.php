    ...
    <section class="content">
      ...
      <div class="box">
            <div class="box-header">
              <h2 class="box-title">
                <a style="margin-left: 0px !important;" href="{{route('purchases.buyAlls')}}">Pay</a></h2>
                <a style="margin-left: 30px !important;" href="{{route('home.index')}}">Continue Shopping</a></h2>
